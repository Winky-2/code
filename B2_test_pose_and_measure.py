...
# ---------------- 設定區 ----------------
POSE_WEIGHTS = "yolo11_pose_run-batch4_重新標註-2/weights_ready.pt"   # 👈 2b_..._fullimage.py訓練完成的權重
...
OUTPUT_XLSX = "yolo像素預測_11_batch4_重新標註-2.xlsx"
RAW_KEYPOINT_CSV = "yolo關鍵點原始座標_11_batch4_重新標註-2.csv"
VIS_DIR = "pose_預測視覺化_11_batch4_重新標註-2"  # 推論結果視覺化輸出資料夾
