...
# ---------------- 設定區 ----------------
CROPPED_INPUT_DIR = "cropped_test_teeth_yolo26"          # 👈 01b輸出的裁切圖片資料夾
RESIZED_OUTPUT_DIR = "resized_test_teeth_yolo26"         # 統一尺寸後的圖片輸出處
...
PREVIOUS_CROP_MANIFEST_XLSX = "33張test裁切結果_yolo26.xlsx"

RESIZE_MANIFEST_XLSX = "33張resize結果_yolo26.xlsx"
